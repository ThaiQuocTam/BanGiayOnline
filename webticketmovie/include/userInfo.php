<?php
    if(isset($_POST['updateInfo'])){
        $sql_updateInfo = mysqli_query($mysqli, "UPDATE `users_info` 
                SET `users_info_name`= '".$_POST['udname']."',`users_info_age`='".$_POST['udage']."',`users_info_gender`='".$_POST['udgender']."',`users_info_phone`='".$_POST['udphone']."'  
                WHERE `users_info_login` =  '".$_SESSION['idUser']."'");
    }
    if(isset($_POST['insertInfo'])){
        $sql_insertInfo = mysqli_query($mysqli, "INSERT INTO 
            `users_info`(`users_info_id`, `users_info_name`, `users_info_gender`, `users_info_age`,`users_info_phone` ,`users_info_login`) 
            VALUES (NULL, '".$_POST['isname']."', '".$_POST['isgender']."','".$_POST['isage']."','" .$_POST['isphone']. "','".$_SESSION['idUser']."')") or die ("lỗi");
    }
