<?php
    ...
    if(isset($_POST['booking'])){
        ...
        $arr = array_map('trim', explode(',', $_SESSION['ticket']));
                ...
                $sql_insertBookingHis = mysqli_query($mysqli, "INSERT INTO `booking` (`booking_id`, `booking_user`, `booking_movie`, `booking_theater`, `booking_ticket`, `booking_time`) 
                VALUES (NULL, '".$_SESSION['idUser']."', '".$_SESSION['IDMovie']."', '".$_SESSION['theaterName']."', '".$_SESSION['ticketName']."', NOW())");
        ...
        if (empty($reserved)) {
            ...
            echo "<script type='text/javascript'>alert('đặt vé không thành công');</script>";
